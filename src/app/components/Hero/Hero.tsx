    ...
    >
      <div className="flex flex-col justify-between h-full px-8 py-4 pt-8 sm:pt-16">
        <div className="flex flex-col gap-1 lg:gap-2">
          <h1 className="text-[#5441A0] tracking-wide text-lg sm:text-2xl md:text-3xl lg:text-4xl uppercase">
            Puntos de Compra o Retiro
          </h1>
          <p
            className={`text-xs sm:text-sm md:text-md lg:text-lg max-w-[300px] sm:max-w-[400px] md:max-w-[400px] lg:max-w-[450px] ${inter.className}`}
          >
        ...
        <div className="flex flex-col gap-4 lg:gap-6">
          <p
            className={`${inter.className} text-xs sm:text-sm md:text-md lg:text-lg`}
          >
            ¿Dónde te encontrás?
          </p>
          <div className="flex flex-col gap-2">
            <button
              className={`${inter.className} tracking-wider font-bold w-1/2 xl:w-2/5
